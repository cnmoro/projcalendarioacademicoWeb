...
@NamedQueries({
    ...
    , @NamedQuery(name = "Usuario.findProfessores", query = "SELECT u FROM Usuario u WHERE u.nivelacesso = 'Professor'")
...
public class Usuario implements Serializable {
    ...
    public Usuario(Integer id, String login, String senha, String email, String nivelacesso) {
        this.id = id;
        this.login = login;
        this.email = email;
        this.senha = senha;
